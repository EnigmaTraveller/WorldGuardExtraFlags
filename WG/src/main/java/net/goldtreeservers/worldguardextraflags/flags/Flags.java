...
public final class Flags {
    ...
    public static final SetFlag<EntityType> ALLOW_ENTITY_PLACE = new SetFlag<>("allow-entity-place", new RegistryFlag<>(null, EntityType.REGISTRY));
    public static final SetFlag<EntityType> DENY_ENTITY_PLACE = new SetFlag<>("deny-entity-place", new RegistryFlag<>(null, EntityType.REGISTRY));
